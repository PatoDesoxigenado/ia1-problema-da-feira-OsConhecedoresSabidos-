...
> **Resposta:**
Resolver em IA possui diversas definições, que vão variar de acordo com o paradigma de IA e o critério estabelecido. Essa diferença ocorre pois o mundo real não é uniforme, e os limites da computação são físicos.
>
>No mundo da IA, aplicada ao mundo real, a natureza do problema dita a ferramenta que usaremos. Em Ambientes Determinísticos, resolver um quebra-cabeça, o ambiente é fechado e exato, e a solução exige perfeição, ou seja, resolver significa encontrar um estado objetivo onde o erro seja 0. Entretanto, nem sempre é possível alcançar esse estado perfeito. Ao calcular a melhor rota, por exemplo, quando temos centenas de variáveis para considerar e o tempo é curto, a perfeição é sacrificada pela velocidade, e nesse caso a IA usará a busca heurística para achar uma resposta que é "boa o suficiente” para poupar tempo e dinheiro, e resolver se torna uma solução aproximada.
>
>Ademais, quando entram os Ambientes Probabilísticos, resolver se torna bem mais complicado, pois o ambiente pode ser ruidoso, incerto e bagunçado. Algumas perguntas não possuem resposta exata, como quanto estará o dólar na semana que vem. A IA faz previsões e ajustes matemáticos, mas resolver aqui é apenas garantir o erro mínimo. Outra situação é termos um problema com várias soluções possíveis, como rotas de entrega; qualquer rota que entregue todos os itens satisfaz o problema, mas o cenário que mais satisfará o usuário muitas vezes vai envolver outros fatores, e aí a IA vai se utilizar da otimização, para assim encontrar a ordem de entregas que gaste o mínimo de gasolina possível. E ainda há momentos em que não haverá nem uma resposta exata, nem uma resposta mais otimizada, mas simplesmente um problema em que a resposta precisa obedecer a certas regras, como montar o horário de dois professores; desde que eles não ocupem a mesma sala no mesmo horário a resposta será satisfatória. Nesse caso, resolver é apenas satisfazer as restrições impostas.
>
>Em essência, tudo isso converge para a busca pelo comportamento racional, onde a IA raramente terá os recursos infinitos necessários para calcular a solução perfeita e absoluta para o mundo real. Portanto, "resolver" em IA é a capacidade de um agente escolher a ação que maximiza a sua utilidade esperada dadas as suas limitações computacionais, adotando critérios de parada claros e entregando uma qualidade aceitável no menor tempo possível.
